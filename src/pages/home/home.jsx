  ...
  return (
    <div className="page" id="home-page">
      <header>
        ...
        <p>
          At De Jesus Contracting, our mission is to deliver precision,
          integrity, and excellence in every job, ensuring unmatched quality and
      ...
      <section className="get-started">
        <p className="opening">
          Make Your Dream Home a Reality with your Local Neighborhood Contractor
        </p>
        <h2>Ready to begin a Project?</h2>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse facere
          magni molestias nesciunt commodi cumque assumenda earum dicta, nemo
          quae ipsam suscipit magnam asperiores quis ducimus non est, nostrum
          corporis incidunt, architecto minus laudantium ullam?
        </p>
